...
public class StudentController {
    ...
    @GetMapping("/courses/not-enrolled")
    public ResponseEntity<List<CourseResponseDTO>> getNotEnrolledCourses() {
        return ResponseEntity.ok(studentService.getNotEnrolledCourses());
    }
