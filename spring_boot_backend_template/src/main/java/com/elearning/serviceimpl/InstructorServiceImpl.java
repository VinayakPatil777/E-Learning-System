...
public class InstructorServiceImpl implements InstructorService {
    ...
    public void deleteCourse(Long courseId, String email) {
        ...
        // 🔥 DELETE ALL CHILD TABLES (ORDER MATTERS)
        enrollmentRepository.deleteByCourse_CourseId(courseId);
        paymentRepository.deleteByCourse_CourseId(courseId);
        videoRepository.deleteByCourse_CourseId(courseId);
        quizRepository.deleteByCourse_CourseId(courseId);
        // materialRepository.deleteByCourse_CourseId(courseId); // if exists
